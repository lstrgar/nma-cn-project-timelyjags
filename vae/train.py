...
from datasets.algonauts_video import AlgonautsVideo
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Train Trajectory Variational Autoencoder"
    )
    parser.add_argument(
        "--model_config",
        dest="model_config",
...
def main():
    ...
    train_data = AlgonautsVideo(train_config["data_path"])
    ...
    train_loader = DataLoader(
        train_data, train_config["batch_size"], shuffle=True, num_workers=2
    )
    ...
    for epoch in range(train_config["num_epochs"]):
        ...
        print(
            "Epoch: {}/{}.............".format(epoch, train_config["num_epochs"]),
            end=" ",
        )
